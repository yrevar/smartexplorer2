...
public class SENfcReaderActivity extends NfcReaderActivity {

	private static final String TAG = SENfcReaderActivity.class.getName();
   ...
   /**
	...
	private void showList() {
		if(message != null && !message.isEmpty()) {
			...
			// display the message
			// show in gui
			ArrayAdapter<? extends Object> adapter = new SENdefRecordAdapter(this, message);
